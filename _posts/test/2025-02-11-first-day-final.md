...
![Image 10: 한 명의 만달로리안 전사가 세련된 갑옷을 입고 사막 지형을 날아가며, 작은 존재를 단단히 품고 있다.](https://imgix.bustle.com/uploads/image/2025/2/10/12cdc9f0/mandalorian-grogu.jpg?w=400&h=300&fit=crop&crop=faces&dpr=2)
###### Lucasfilm
...
![Anthony Harvey/Shutterstock](https://www.shutterstock.com/image-photo/sigourney-weaver-attending-event-2025)
###### Anthony Harvey/Shutterstock

〈만달로리안〉 시즌 3의 마지막에서 딘 자린은 그로구와 함께 반은 은퇴한 상태에 접어들었기 때문에, 위버가 연기하는 캐릭터는 그를 다시 임무에 나서게 할 만큼 충분한 영향력을 가진 인물일 가능성이 크다. 이는 아마도 그녀가 신공화국에서 중요한 위치를 차지하는 인물일 수도 있음을 의미한다. 딘 자린을 임무로 파견하며 그에게 더 큰 목표를 이루는 데 도움을 약속하는 존재라면, 이는 전형적인 〈만달로리안〉 게스트 캐릭터의 역할과도 유사하다. 하지만 이 역할이 그 자체로 흥미로운 이유는 바로 그 평범함에 있다.

이처럼 익숙한 캐릭터를 활용한다는 점은 〈만달로리안 & 그로구〉가 기존 〈만달로리안〉 에피소드와 같은 구조를 따를 가능성이 높다는 의미다. 즉, 독립적인 모험이 진행된 후 엔딩 크레딧이 올라가는 방식이 될 수 있다. 물론 이번 영화에서는 훨씬 더 높은 긴장감과 위기가 등장할 가능성이 크다. 위버가 말한 “온갖 나쁜 일”이라는 표현도 불길한 암시를 담고 있다. 팬들은 이번 영화가 〈만달로리안〉 시즌 4를 대체하는 작품이라고 추측해 왔다. 만약 그 예상이 맞다면, 적어도 이 영화는 만달로리안이 등장하는 단순한 영화가 아니라, 하나의 장편 에피소드처럼 느껴질 것이다.

#### 〈만달로리안 & 그로구〉는 2026년 5월 22일 개봉한다.
